...
# -*- coding: utf-8 -*-
"""
AIS → Transits Acoustic Filter (Bush Point)
-------------------------------------------
Collect AIS within 30 km radius, filter acoustically relevant transits
(CPA ≤ 20 km, min dwell 60 s, min 3 AIS points).
Adds relative bearing, site name, and high-quality tag.
Automatically locates /Sites/Bush_Point_data from any script location.
"""
...
# === CONFIGURATION ===
HYDRO_LAT, HYDRO_LON = 48.0336664, -122.6040035   # Bush Point hydrophone coordinates
SITE_NAME = "Bush_Point"

RADIUS_M = 30000                  # Subscription radius (30 km)
CPA_MAX_M = 20000                 # Acoustic relevance threshold (20 km)
MIN_SOG_KT = 2                    # Minimum vessel speed (knots)
MIN_POINTS = 3                    # Minimum number of AIS points inside radius
MIN_DWELL_SEC = 60                # Minimum dwell time (seconds)
HIGH_QUALITY_THRESHOLD = 1000     # "high-quality" if CPA < 1 km


# --- Project root / BASE_DIR fix ---
def find_project_root(start_path):
    cur = os.path.abspath(start_path)
    for _ in range(6):  # 防御性上限
...
def parse_args():
    parser = argparse.ArgumentParser(description="Filter AIS transits for Bush Point site.")
