#!/usr/bin/env python3
"""
AIS → Transits Acoustic Filter (Port Townsend)
---------------------------------------------
...
Automatically locates /Sites/Port_Townsend_data from any script location.
"""
...
# === CONFIGURATION ===
HYDRO_LAT, HYDRO_LON = 48.135743, -122.760614  # Port Townsend hydrophone
SITE_NAME = "Port_Townsend"
...
def parse_args():
    parser = argparse.ArgumentParser(description="Filter AIS transits for Port Townsend site.")
