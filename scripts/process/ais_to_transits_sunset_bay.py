#!/usr/bin/env python3
"""
AIS → Transits Acoustic Filter (Sunset Bay)
------------------------------------------
...
Automatically locates /Sites/Sunset_Bay_data from any script location.
"""
...
# === CONFIGURATION ===
HYDRO_LAT, HYDRO_LON = 47.86497296593844, -122.33393605795372  # Sunset Bay hydrophone
SITE_NAME = "Sunset_Bay"

RADIUS_M = 30000                 # Subscription radius (30 km)
CPA_MAX_M = 8000                 # Acoustic relevance threshold (3 km)
...
def parse_args():
    parser = argparse.ArgumentParser(description="Filter AIS transits for Sunset Bay site.")
